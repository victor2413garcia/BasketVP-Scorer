...
"color: rgb(255, 255, 255);")
        ...
        self.label_13.setStyleSheet("color: rgb(46, 52, 54)")
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.radioButton_4)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_10.setText(_translate("Form", "TOTALES"))
        self.label_7.setText(_translate("Form", "Puntos"))
        self.label_6.setText(_translate("Form", "Faltas"))
        self.label_11.setText(_translate("Form", "PROMEDIOS"))
        self.label_12.setText(_translate("Form", "Puntos"))
        self.label_13.setText(_translate("Form", "Faltas"))
        self.label_4.setText(_translate("Form", "FILTROS"))
        self.tableWidget.setSortingEnabled(True)
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Nombre"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Equipo"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Total Puntos"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Prom. Puntos"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Total Faltas"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Form", "Prom. Faltas"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Juegos"))
