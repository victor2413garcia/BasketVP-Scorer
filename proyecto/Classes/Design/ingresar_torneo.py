...
# Form implementation generated from reading ui file 'Ingresar_Torneo.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(70, 80, 171, 41))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Ingrese nombre del torneo"))
        self.lineEdit.setPlaceholderText(_translate("Dialog", "Ej: NBA 2022"))
